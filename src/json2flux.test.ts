...
test('It should return correct flux query', () => {
  expect(json2flux(fluxQuery as FluxJsonQuery)).toEqual(`from(bucket: "mainflux_1h")
  |> range(start: -7d)
...
test('It should return correct complex flux query', () => {
  expect(json2flux(fluxQueryComplex as FluxJsonQuery)).toEqual(`from(bucket: "mainflux")
